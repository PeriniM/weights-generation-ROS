...
w_com =  3e-1       #5e-1       # weight of center of mass task (ref trajectory)
if SQUAT:
    w_squat = 100                # weight of squat task
else:
    w_squat = 0                 # weight of squat task
w_foot = 100        #1e-1                   # weight of the foot motion task
w_contact = 1e2                 # weight of the foot in contact
w_posture = 2e-4    #1e-4       # weight of joint posture task
w_forceRef = 1e-51               # weight of force regularization task
